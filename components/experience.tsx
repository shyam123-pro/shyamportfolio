...
const experiences: ExperienceItem[] = [
  {
    company: "Tavishi Advisory and Consultancy Services Pvt. Ltd.",
    role: "Software Development & Testing Intern",
    duration: "02 June 2025 - 16 July 2025",
    location: "B-285, Swarnjayantipuram, Govindpuram, Ghaziabad, U.P. - 201013",
    type: "Internship",
    description: [
      "Completed a 6-week internship contributing to the development and testing of an Office ERP System.",
      "Actively worked on the “My Attendance” module and other components using React for frontend enhancements.",
      "Performed both manual and automated testing using Selenium WebDriver with Python, improving system stability and user experience.",
      "Assisted in frontend development, fixing UI issues and optimizing component functionality.",
      "Involved in database tasks, including test data setup and basic querying for validation and testing purposes.",
      "Collaborated with the development and QA teams to ensure quality, consistency, and performance across modules.",
    ],
    technologies: ["Python", "React", "HTML/CSS", "MongoDB", "MySQL", "Git", "Selenium"],
    tools: ["Git", "GitHub", "VS Code"],
    achievements: [
      "Collaborated with team to improve ERP system performance.",
      "Actively contributed to frontend development using React.js.",
      "Performed manual and automated testing with Selenium & Python.",
      "Supported database validation and basic query tasks.",
    ],
  },
